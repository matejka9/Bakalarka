...
package com.example.dusky.myapplication.backend.user;
...
public class User extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class LogIn extends UserRequest<com.example.dusky.myapplication.backend.user.model.UserEntityModel> {
     ...
     */
    protected LogIn() {
      super(User.this, "GET", REST_PATH, null, com.example.dusky.myapplication.backend.user.model.UserEntityModel.class);
    }
  ...
  public class Register extends UserRequest<com.example.dusky.myapplication.backend.user.model.UserEntityModel> {
